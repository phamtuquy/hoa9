...
function azera_shop_customize_register( $wp_customize ) {
	...
	****************     FRONTPAGE SECTIONS    */
	...
	$wp_customize->add_section( 'azera_shop_header_content' , array(
		'title'       => esc_html__( 'Big title section 1', 'azera-shop' ),
		'priority'    => 1,
	...
	$wp_customize->add_setting( 'azera_shop_header_button_more_text', array(
		'default' => esc_html__( 'FIND OUT MORE','azera-shop' ),
		'sanitize_callback' => 'azera_shop_sanitize_text',
		'transport' => 'postMessage',
	));
	$wp_customize->add_control( 'azera_shop_header_button_more_text', array(
		'label'    => esc_html__( 'Button More label', 'azera-shop' ),
		'section'  => 'azera_shop_header_content',
		'priority'    => 60,
	));

	$wp_customize->add_setting( 'azera_shop_header_button_more_link', array(
		'default' => esc_html__( '#','azera-shop' ),
		'sanitize_callback' => 'esc_url',
		'transport' => 'postMessage',
	));
	$wp_customize->add_control( 'azera_shop_header_button_more_link', array(
		'label'    => esc_html__( 'Button More link', 'azera-shop' ),
		'section'  => 'azera_shop_header_content',
		'priority'    => 70,
	));
	...
	$wp_customize->add_section( 'azera_shop_propositions_section' , array(
		'title'       => esc_html__( 'Propositions options', 'azera-shop' ),
		'priority'    => 3,
		'panel' => 'azera_shop_front_page_sections',
		'active_callback'   => 'azera_shop_show_on_front',
	));
	
	$default = azera_shop_propositions_get_default_content();
	$wp_customize->add_setting( 'azera_shop_propositions_content', array(
		'sanitize_callback' => 'azera_shop_sanitize_repeater',
		'default' => $default,
	) );
	$wp_customize->add_control( new Azera_Shop_General_Repeater( $wp_customize, 'azera_shop_propositions_content', array(
		'label'   => esc_html__( 'Add new Propositions','azera-shop' ),
		'section' => 'azera_shop_propositions_section',
		'priority' => 10,
		'azera_shop_image_control' => true,
		'azera_shop_checkbox_control' => true,
		'azera_shop_title_control' => true,
		'azera_shop_text_control' => true,
	) ) );
	
	$wp_customize->add_setting( 'azera_shop_propositions_title_one', array(
		'sanitize_callback' => 'azera_shop_sanitize_text',
		'transport' => 'postMessage',
	));
	$wp_customize->add_control( 'azera_shop_propositions_title_one', array(
		'label'    => esc_html__( 'Title proposition 1', 'azera-shop' ),
		'section'  => 'azera_shop_propositions_section',
		'priority'    => 20,
	));
	
	$wp_customize->add_setting( 'azera_shop_propositions_text_one', array(
		'sanitize_callback' => 'azera_shop_sanitize_text',
		'transport' => 'postMessage',
	));
	$wp_customize->add_control( 'azera_shop_propositions_text_one', array(
		'label'    => esc_html__( 'Text proposition 1', 'azera-shop' ),
		'section'  => 'azera_shop_propositions_section',
		'priority'    => 21,
		'type'     => 'textarea',
	));
	
	$wp_customize->add_setting( 'azera_shop_propositions_image_one', array(
		'sanitize_callback' => 'esc_url',
		'transport' => 'postMessage',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'azera_shop_propositions_image_one', array(
	      	'label'    => esc_html__( 'Image prosition 1', 'azera-shop' ),
	      	'section'  => 'azera_shop_propositions_section',
			'priority'    => 22,
	)));
	
	
	$wp_customize->add_setting( 'azera_shop_propositions_title_two', array(
		'sanitize_callback' => 'azera_shop_sanitize_text',
		'transport' => 'postMessage',
	));
	$wp_customize->add_control( 'azera_shop_propositions_title_two', array(
		'label'    => esc_html__( 'Title proposition 2', 'azera-shop' ),
		'section'  => 'azera_shop_propositions_section',
		'priority'    => 30,
	));
	
	$wp_customize->add_setting( 'azera_shop_propositions_text_two', array(
		'sanitize_callback' => 'azera_shop_sanitize_text',
		'transport' => 'postMessage',
	));
	$wp_customize->add_control( 'azera_shop_propositions_text_two', array(
		'label'    => esc_html__( 'Text proposition 2', 'azera-shop' ),
		'section'  => 'azera_shop_propositions_section',
		'priority'    => 31,
		'type'     => 'textarea',
	));
	
	$wp_customize->add_setting( 'azera_shop_propositions_image_two', array(
		'sanitize_callback' => 'esc_url',
		'transport' => 'postMessage',
	));
	...
	$wp_customize->add_control( 'azera_shop_propositions_title_three', array(
		'label'    => esc_html__( 'Title proposition 3', 'azera-shop' ),
		'section'  => 'azera_shop_propositions_section',
		'priority'    => 40,
	));
	
	$wp_customize->add_setting( 'azera_shop_propositions_text_three', array(
		'sanitize_callback' => 'azera_shop_sanitize_text',
		'transport' => 'postMessage',
	));
	$wp_customize->add_control( 'azera_shop_propositions_text_three', array(
		'label'    => esc_html__( 'Text proposition 3', 'azera-shop' ),
		'section'  => 'azera_shop_propositions_section',
		'priority'    => 41,
		'type'     => 'textarea',
	));
	
	$wp_customize->add_setting( 'azera_shop_propositions_image_three', array(
		'sanitize_callback' => 'esc_url',
		'transport' => 'postMessage',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'azera_shop_propositions_image_three', array(
	      	'label'    => esc_html__( 'Image prosition 3', 'azera-shop' ),
	      	'section'  => 'azera_shop_propositions_section',
			'priority'    => 42,
	)));
	/**
	...
	************ ADVANCED OPTIONS  */
	...
	$wp_customize->add_panel( 'test_panel', array(
		'priority' => 1,
		'title' => esc_html__('My Test Panel', 'azera-shop')
	) );
	
	$wp_customize->add_section('azera_shop_my_test_section', array(
		'title'		=> esc_html__( 'My test section', 'azera-shop' ),
		'priority'	=> 86,
	));
	
	$wp_customize->add_setting( 'azera_shop_my_test_setting', array(
		'sanitize_callback' => 'azera_shop_sanitize_text',
		'transport' 		=> 'postMessage',
	));
	
	$wp_customize->add_control( 'azera_shop_my_test_setting', array(
		'label'    			=> esc_html__( 'My test text', 'azera-shop' ),
		'section'  			=> 'azera_shop_my_test_section',
		'priority'    		=> 2,
	));
}
