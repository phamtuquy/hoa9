	...
	<div class="section-overlay-layer">
		<div class="container">
			...
			if ( class_exists( 'WooCommerce' ) ) :
				...
				<div class="home-shop-product woocommerce"> <!-- #how9 -->
					<div class="azera_shop_products_container products"> <!-- #how9 -->
						<?php
						if ( $cat == 'all' ) {
							$args = array(
								'post_type' => 'product',
						...
						while ( $loop->have_posts() ) : $loop->the_post();
							...
							<div class="col-md-4 col-sm-6 home-shop-product-wrap-all product"> <!-- #how9 -->
